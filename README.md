...
./docs/technical-specs/
  <feature>/
    ...
    04-feature-memory.md     (generated — shared context for ticket execution)
    tickets/
      STK-001.md
      STK-002.md
...
**Agent roles:** `planner` (generates execution plan + tickets), `tester` (writes failing tests, TDD only), `worker` (implements), `reviewer` (reviews and writes reviewer notes), `chief` (writes feature memory + worker context / continuation notes).
